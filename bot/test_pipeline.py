...
async def test_trade_pipeline():
    ...
    print("=" * 60)
    print("[TEST] TRADE PIPELINE TEST")
    print("=" * 60)
    ...
    try:
        ...
        print("   [OK] BUY event processed")
    except Exception as e:
        print(f"   [ERROR] BUY event failed: {e}")
    
    # Test Event 2: SELL
    print("\n[2] Testing SELL Event...")
    ...
    try:
        ...
        print("   [OK] SELL event processed")
    except Exception as e:
        print(f"   [ERROR] SELL event failed: {e}")
    
    # Test Event 3: Mit Timestamp
    print("\n[3] Testing Event with Timestamp...")
    import time
    ...
    try:
        ...
        print("   [OK] Timed event processed")
        print(f"    Timestamp: {timed_event.timestamp}")
    except Exception as e:
        print(f"   [ERROR] Timed event failed: {e}")
